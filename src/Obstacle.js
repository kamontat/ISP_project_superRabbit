var Obstacle = cc.Sprite.extend({
    ctor: function () {
        ...
        if (this.numOfRand == 1) {
            this.initWithFile('res/image/monsterfile/Monster1.png');
        } else if (this.numOfRand == 2) {
            this.initWithFile('res/image/monsterfile/Monster2.png');
        } else if (this.numOfRand == 3) {
            this.initWithFile('res/image/monsterfile/Monster3.png');
        } else if (this.numOfRand == 4) {
            this.initWithFile('res/image/monsterfile/Monster4.png');
        } else if (this.numOfRand == 5) {
            this.initWithFile('res/image/monsterfile/Monster5.png');
        } else {
            this.initWithFile('res/image/monsterfile/Monster6.png');
        }
